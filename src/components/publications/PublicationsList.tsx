                    ...
                    filteredPublications.map((pub, index) => (
                        ...
                        >
                            <div className="flex flex-col md:flex-row">
                                {/* Left: Image/Video */}
                                <div className="w-full md:w-72 flex-shrink-0 p-4">
                                    {pub.video ? (
                                        ...
                                        <div className="w-full aspect-[4/3] flex items-center justify-center bg-neutral-50 dark:bg-neutral-800 rounded-lg">
                                            <BookOpenIcon className="h-16 w-16 text-neutral-300 dark:text-neutral-600" />
                                        </div>
                                    )}
                                </div>

                                {/* Right: Content */}
                                <div className="flex-grow p-6 flex flex-col min-h-[220px]">
                                    {/* Title */}
                                    <h3 className={`${embedded ? "text-base" : "text-lg"} font-semibold text-primary mb-2 leading-snug group-hover:text-accent transition-colors`}>
                                        {pub.title}
                                    </h3>
                                    ...
                                    {/* Venue */}
                                    <p className="text-xs font-medium text-neutral-500 dark:text-neutral-500 mb-3">
                                    ...
                                    <div className="flex flex-wrap gap-2 pt-3 border-t border-neutral-100 dark:border-neutral-800">
                                        ...
                                        {pub.arxivId && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="inline-flex items-center px-3 py-1.5 rounded-md text-xs font-medium bg-orange-50 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400 hover:bg-orange-100 dark:hover:bg-orange-900/40 transition-colors"
                                            >
                                                arXiv
                                            </a>
                                        )}
                                        {pub.webpage && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="inline-flex items-center px-3 py-1.5 rounded-md text-xs font-medium bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-colors"
                                            >
                                                Webpage
                                            </a>
                                        )}
                                        {pub.code && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="inline-flex items-center px-3 py-1.5 rounded-md text-xs font-medium bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 hover:bg-green-100 dark:hover:bg-green-900/40 transition-colors"
                                            >
                                                Code
                                            </a>
                                        )}
                                        {pub.doi && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="inline-flex items-center px-3 py-1.5 rounded-md text-xs font-medium bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors"
                                            >
                                                DOI
                                            </a>
                                        )}
