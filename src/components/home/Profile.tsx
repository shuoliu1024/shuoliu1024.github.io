...
export default function Profile({ author, social, features, researchInterests, bioText }: ProfileProps) {
    ...
    return (
        ...
        >
            ...
            <div className="text-center mb-6">
                ...
                {Array.isArray(author.title) ? (
                    author.title.map((line, index) => (
                        <p key={index} className="text-lg text-accent font-medium mb-1">
                            {line}
                        </p>
                    ))
                ) : (
            ...
            {/* Bio Text or Research Interests */}
            {bioText ? (
